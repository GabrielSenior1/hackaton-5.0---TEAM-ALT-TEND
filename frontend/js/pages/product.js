 ...
 * Adapted from the user's first HTML mockup
 */
      ...
      <main class="container" style="padding-top: 40px; padding-bottom: 60px;">
        <div class="grid-12" style="align-items: start;">
          ...
          <div class="col-span-full md-col-7" style="display: flex; justify-content: center;">
            <div style="position: relative; width: 100%; max-width: 640px; background: var(--surface-container-low); border-radius: 0.5rem; padding: 32px; display: flex; justify-content: center; align-items: center;" class="soft-shadow">
              <img 
                ...
                style="width: 100%; max-height: 600px; object-fit: cover; border-radius: 0.25rem; box-shadow: var(--shadow-sm);"
              />
              <div style="position: absolute; top: 16px; left: 16px; background: var(--surface); color: var(--secondary); padding: 6px 14px; border-radius: 2px; border: 0.5px solid var(--secondary); backdrop-filter: blur(8px); background: rgba(255,248,245,0.9);" class="label-sm" style="letter-spacing: 0.15em;">
                LOTE #0492
              </div>
            </div>
          </div>
          ...
          <div class="col-span-full md-col-5" style="display: flex; flex-direction: column; gap: 32px; padding-left: 0; padding-top: 32px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
              <h2 class="headline-xl" style="color: var(--on-background);">Reserva tu Lote</h2>
            ...
            <div class="card-flat" style="display: flex; flex-direction: column; gap: 24px; padding: 28px;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--outline-variant); padding-bottom: 16px;">
                ...
                <span class="headline-lg" style="color: var(--secondary);">$14.00</span>
              </div>
              ...
              <div class="form-field">
                ...
                <div style="position: relative;">
                  <select class="form-field__select" id="shipping-country">
                  ...
                  <div style="position: absolute; inset-block: 0; right: 0; display: flex; align-items: center; padding-right: 4px; pointer-events: none;">
              ...
              <div class="form-field">
                ...
                <div style="display: flex; align-items: center; gap: 16px;">
                  <button id="qty-minus" style="width: 40px; height: 40px; border-radius: 50%; background: var(--surface-container-highest); display: flex; align-items: center; justify-content: center; font-size: 20px; color: var(--on-surface); transition: all 0.2s ease;" onmouseover="this.style.background='var(--secondary-container)'" onmouseout="this.style.background='var(--surface-container-highest)'">−</button>
                  <span id="qty-value" class="headline-md" style="min-width: 40px; text-align: center;">1</span>
                  <button id="qty-plus" style="width: 40px; height: 40px; border-radius: 50%; background: var(--surface-container-highest); display: flex; align-items: center; justify-content: center; font-size: 20px; color: var(--on-surface); transition: all 0.2s ease;" onmouseover="this.style.background='var(--secondary-container)'" onmouseout="this.style.background='var(--surface-container-highest)'">+</button>
                </div>
              </div>
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 0; border-top: 1px solid var(--outline-variant);">
                ...
                <span id="total-price" class="headline-lg" style="color: var(--secondary);">$14.00</span>
              </div>

              <!-- Buy Button -->
              <button class="btn btn-primary btn-full" style="padding: 18px; border-radius: 0.25rem; flex-direction: column; gap: 4px;" id="buy-btn">
                <span>COMPRAR AHORA</span>
                <span style="font-size: 10px; opacity: 0.8; text-transform: none; letter-spacing: normal;">Apoya a la Comunidad Local</span>
              </button>
            </div>
...
export function initProduct() {
  ...
  document.getElementById('buy-btn')?.addEventListener('click', () => {
    ...
    if (showToast) showToast('¡Pedido registrado! Te contactaremos pronto.', 'success');
  });
}
