    ...
    <div class="page-content">
      <main class="container" style="padding-top: 40px; padding-bottom: 60px; display: flex; flex-direction: column; align-items: center; gap: 48px;">
        ...
        <section style="text-align: center; display: flex; flex-direction: column; gap: 16px; max-width: 520px;">
          ...
          <h2 class="headline-xl gold-gradient-text">${t('model3d.title')}</h2>
          ...
          <div class="model-viewer-container" id="model-container">
            ...
            >
              ...
              <div slot="poster" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; gap: 20px; background: var(--surface-container);">
                ...
                <p class="label-sm" style="color: var(--outline);">${t('model3d.uploadHint')}</p>
              </div>
        ...
        <section style="width: 100%; max-width: 600px; display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          <div class="card-flat" style="text-align: center;">
            ...
            <p class="label-sm" style="color: var(--on-surface-variant);">${t('model3d.dragToRotate')}</p>
          </div>
          <div class="card-flat" style="text-align: center;">
            <span class="material-symbols-outlined" style="color: var(--secondary); font-size: 32px; margin-bottom: 8px;">pinch_zoom_in</span>
            <p class="label-sm" style="color: var(--on-surface-variant);">${t('model3d.pinchToZoom')}</p>
          </div>
        </section>
        ...
        <section style="width: 100%; max-width: 600px;">
          <div class="card-flat" style="display: flex; flex-direction: column; gap: 16px;">
            <h3 class="headline-md">${t('model3d.about')}</h3>
            <p class="body-md" style="color: var(--on-surface-variant);">
              ${t('model3d.aboutDesc')}
            </p>
            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
              <span style="background: var(--tertiary-container); color: var(--on-tertiary-container); padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight: 600;">♻️ ${t('model3d.tag.biodegradable')}</span>
              <span style="background: var(--secondary-container); color: var(--on-secondary-container); padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight: 600;">🎨 ${t('model3d.tag.artisan')}</span>
              <span style="background: var(--primary-fixed); color: var(--on-primary-fixed-variant); padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight: 600;">🔒 ${t('model3d.tag.qr')}</span>
            </div>
          </div>
        </section>
