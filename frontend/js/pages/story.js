      ...
      <main class="container" style="padding-top: 40px; padding-bottom: 60px; display: flex; flex-direction: column; gap: 64px;">
          ...
          <div class="grid-12" style="align-items: center;">
            ...
            <div class="col-span-full md-col-6">
              <div style="position: relative; border-radius: 1rem; overflow: hidden; aspect-ratio: 4/5;" class="soft-shadow">
                ...
                <div style="position: absolute; top: 16px; left: 16px; background: rgba(255,255,255,0.9); backdrop-filter: blur(8px); padding: 6px 14px; border-radius: 9999px; display: flex; align-items: center; gap: 8px;" class="micro-gold-border">
                  ...
                  <span class="label-sm" style="color: var(--on-surface-variant);">${t('story.uniqueOrigin')}</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-span-full md-col-6" style="display: flex; flex-direction: column; justify-content: center; gap: 24px; padding-top: 32px;">
              <div>
                ...
                <p class="label-sm" style="color: var(--outline); letter-spacing: 0.15em;" id="producer-gen">3ª ${t('story.generation')}</p>
              </div>
        ...
        <section>
          <div style="display: flex; flex-direction: column; gap: 16px;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
              <h3 class="headline-md" style="color: var(--on-background);">${t('story.terroir')}</h3>
            ...
            <div style="position: relative; width: 100%; height: 300px; border-radius: 1rem; overflow: hidden; background: var(--surface-container-highest); display: flex; align-items: center; justify-content: center; cursor: pointer;" class="soft-shadow" id="map-container">
              ...
              <div style="position: relative; z-index: 1; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 12px;">
                ...
                <p class="headline-md" style="color: var(--on-surface);">${t('story.location')}</p>
                <p class="body-md" style="color: var(--on-surface-variant);">${t('story.coordinates')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="timeline" id="journey-timeline">
            <div class="timeline__item stagger-1" style="animation-delay: 0.3s;">
              ...
              <div class="timeline__content">${t('story.journey.sowing')}</div>
            ...
            <div class="timeline__item stagger-2" style="animation-delay: 0.5s;">
              ...
              <div class="timeline__content">${t('story.journey.monitoring')}</div>
            ...
            <div class="timeline__item stagger-3" style="animation-delay: 0.7s;">
              ...
              <div class="timeline__content">${t('story.journey.harvest')}</div>
            ...
            <div class="timeline__item stagger-4" style="animation-delay: 0.9s;">
              <div class="timeline__time">Abril 2026</div>
              <div class="timeline__content">${t('story.journey.fermentation')}</div>
            ...
            <div class="timeline__item stagger-5" style="animation-delay: 1.1s;">
              ...
              <div class="timeline__content">${t('story.journey.drying')}</div>
        ...
        <section style="max-width: 600px; margin: 0 auto; width: 100%;">
          <div class="card-flat" style="text-align: center; display: flex; flex-direction: column; gap: 20px;">
            <h3 class="headline-md">${t('story.flavorProfile')}</h3>
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;" id="flavor-tags">
              <span style="background: var(--tertiary-container); color: var(--on-tertiary-container); padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600;">🍒 ${t('story.flavor.redFruits')}</span>
              <span style="background: var(--secondary-container); color: var(--on-secondary-container); padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600;">🍫 ${t('story.flavor.intense')}</span>
              <span style="background: var(--primary-fixed); color: var(--on-primary-fixed-variant); padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600;">🪵 ${t('story.flavor.wood')}</span>
              <span style="background: var(--surface-container-highest); color: var(--on-surface); padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600;">🌰 ${t('story.flavor.nut')}</span>
              <span style="background: var(--tertiary-container); color: var(--on-tertiary-container); padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600;">🌿 ${t('story.flavor.herbal')}</span>
            </div>
            <div style="width: 80%; margin: 0 auto;">
              <div style="display: flex; justify-content: space-between; margin-bottom: 6px;">
                <span class="label-sm" style="color: var(--on-surface-variant);">${t('story.qualityScore')}</span>
